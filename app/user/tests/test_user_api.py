...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload={'email':'testuser@gamil.com','password':'user1234'}
    ...
    def test_password_too_short(self):
        ...
        payload={'email':'testuser@gamil.com','password':'us'}
        res=self.client.post(CREATE_USER_URL,payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='testuser@gamil.com',password='user1234')
        payload={'email':'testuser@gamil.com','password':'wrong'}
        res=self.client.post(TOKEN_URL,payload)
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        payload={'name':'patch name','password':'patch password'}
